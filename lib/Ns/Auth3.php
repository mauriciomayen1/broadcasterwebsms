 ...
 */
class Ns_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    /**
     * Database Connection
     *
                                ...
                                $credentialColumn = null, $credentialTreatment = null)
    {
		...
		$tableName 		     = $config->application['auth']['tableName'];
		$identityColumn 	 = $config->application['auth']['identityColumn'];
		$credentialColumn    = $config->application['auth']['credentialColumn'];
		$credentialTreatment = $config->application['auth']['credentialTreatment'];
