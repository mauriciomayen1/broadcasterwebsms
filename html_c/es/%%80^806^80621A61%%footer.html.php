<?php /* Smarty version 2.6.20, created on 2017-04-07 11:02:00
    ...
    <!-- gauge js -->
    <script type="text/javascript" src="../html/es/js/gauge/gauge.min.js"></script>
    <script type="text/javascript" src="../html/es/js/gauge/gauge_demo.js"></script>
    <!-- chart js -->
    ...
    <!-- daterangepicker -->
    <script type="text/javascript" src="../html/es/js/moment.min.js"></script>
    ...
    <!-- worldmap -->
    <script type="text/javascript" src="../html/es/js/maps/jquery-jvectormap-2.0.1.min.js"></script>
    <script type="text/javascript" src="../html/es/js/maps/gdp-data.js"></script>
    <script type="text/javascript" src="../html/es/js/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script type="text/javascript" src="../html/es/js/maps/jquery-jvectormap-us-aea-en.js"></script>
    <script>
        $(function () {
    ...
    <script>
        var doughnutData = [
            {
                value: <?php echo $this->_tpl_vars['porcentaje_telcel']; ?>
,
                color: "#3498DB"
            },
            {
                value: <?php echo $this->_tpl_vars['porcentaje_movistar']; ?>
,
                color: "#1ABB9C"
            },
            {
                value: <?php echo $this->_tpl_vars['porcentaje_iusacell']; ?>
,
                color: "#007aff"
            }
    ];
